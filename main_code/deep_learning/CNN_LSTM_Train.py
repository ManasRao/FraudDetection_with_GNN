...
def main():
    """
        ...
        initializes a CNN_LSTM model, and trains and validates the model.
    ...
    model = CNN_LSTM(args.cnn_input_size, args.hidden_size, args.hidden_size_2, args.lstm_n_layers, args.cnn_lstm_out_size, args.output_dim, args.kernel_size,
