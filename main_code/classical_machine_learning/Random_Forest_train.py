...
def train_model(X_train, y_train, params={}):
    ...
    :param params: Random Forest parameters
...
def main():
    ...
    default_output_path = "../../../Data/Predictions/Random Forest/predictions_Random_Forest.csv"
    default_model_path = "models/Random Forest/random_forest_model.pkl"
    ...
    parser.add_argument('--output_path', type=str, default=default_output_path,
                        help='Path to save the predictions. Default: Data/Predictions/Random Forest/predictions_Random Forest.csv')
    parser.add_argument('--model_path', type=str, default=default_model_path,
                        help='Path to save the trained model. Default: Models/Random Forest/random_forest_model.pkl')
    ...
    parser.add_argument('--max_depth', type=int, default=None, help='Maximum depth of the tree. Default: None')
    parser.add_argument('--min_samples_split', type=int, default=2, help='Minimum number of samples required to split an internal node. Default: 2')
    parser.add_argument('--min_samples_leaf', type=int, default=1, help='Minimum number of samples required to be at a leaf node. Default: 1')
    parser.add_argument('--n_jobs', type=int, default=-1, help='Number of jobs to run in parallel. Default: -1')
    ...
    if not args.train_only:
        ...
        display_results(model, X_test, y_test, title = 'Random Forest Results')
