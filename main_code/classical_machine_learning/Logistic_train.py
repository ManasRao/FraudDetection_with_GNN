...
def train_model(X_train, y_train, params = {}):
    ...
    :param params: Logistic Regression parameters
...
def main():
    ...
    default_output_path = "../../../Data/Predictions/Logistic Regression/predictions_Logistic_Regression.csv"
    default_model_path = "models/Logistic Regression/logistic_regression_model.pkl"
        
    parser = argparse.ArgumentParser(description='Train an Logistic Regression model for binary classification')
    ...
    parser.add_argument('--output_path', type=str, default=default_output_path,
                        help='Path to save the predictions. Default: Data/Predictions/Logistic Regression/predictions_Logistic_Regression.csv')
    parser.add_argument('--model_path', type=str, default=default_model_path,
                        help='Path to save the trained model. Default: Models/Logistic Regression/logistic_regression_model.pkl')
    ...
    parser.add_argument('--C', type=float, default=1.0, help='Inverse of regularization strength. Default: 1.0')
    parser.add_argument('--penalty', type=str, default='l2', help='Penalty for regularization. Options: l1, l2, elasticnet, none. Default: l2')
    parser.add_argument('--solver', type=str, default='lbfgs', help='Solver for optimization. Options: newton-cg, lbfgs, liblinear, sag, saga. Default: lbfgs')
    parser.add_argument('--max_iter', type=int, default=5000, help='Maximum number of iterations. Default: 5000')
    ...
    if not args.train_only:
        ...
        display_results(model, X_test, y_test, title='Logistic Regression Results')
